...
Lets make a very naive implementation that internally uses an ordered `std::set`.
...
And we need to implement the scheduler API.
...
[Link to godbolt](https://godbolt.org/z/sTfrG36Ph)
...
[Link to godbolt](https://godbolt.org/z/hK3GzP3x9)
